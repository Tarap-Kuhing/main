...
echo -e "$green   ...........................................................$NC"
echo ''
echo -e "$green                   Telegram:$NC $red@Baung2012               $NC"
...
echo "IP=$host" >> /var/lib/Tarap-Kuhing/ipvps.conf
...
#install v2ray
wget https://raw.githubusercontent.com/Tarap-Kuhing/main/main/install/ins-vt.sh && chmod +x ins-vt.sh && screen -S v2ray ./ins-vt.sh
#install ssh ovpn
wget https://raw.githubusercontent.com/Tarap-Kuhing/main/main/install/ssh-vpn.sh && chmod +x ssh-vpn.sh && screen -S ssh-vpn ./ssh-vpn.sh
wget https://raw.githubusercontent.com/Tarap-Kuhing/main/main/install/sstp.sh && chmod +x sstp.sh && screen -S sstp ./sstp.sh
#install ssr
wget https://raw.githubusercontent.com/Tarap-Kuhing/main/main/install/ssr.sh && chmod +x ssr.sh && screen -S ssr ./ssr.sh
wget https://raw.githubusercontent.com/Tarap-Kuhing/main/main/install/sodosok.sh && chmod +x sodosok.sh && screen -S ss ./sodosok.sh
#installwg
wget https://raw.githubusercontent.com/Tarap-Kuhing/main/main/install/wg.sh && chmod +x wg.sh && screen -S wg ./wg.sh
#install L2TP
wget https://raw.githubusercontent.com/Tarap-Kuhing/main/main/install/ipsec.sh && chmod +x ipsec.sh && screen -S ipsec ./ipsec.sh
wget https://raw.githubusercontent.com/Tarap-Kuhing/main/main/install/set-br.sh && chmod +x set-br.sh && ./set-br.sh
# Install Neofetch
#install edu
wget https://raw.githubusercontent.com/Tarap-Kuhing/main/main/install/cdn.sh && chmod +x cdn.sh && screen -S cdn.sh ./cdn.sh
#install ohp
wget https://raw.githubusercontent.com/Tarap-Kuhing/main/main/install/ohp-db.sh && chmod +x ohp-db.sh && screen -S ohp-db.sh ./ohp-db.sh
...
wget -O /etc/set.sh "https://raw.githubusercontent.com/Tarap-Kuhing/main/main/set.sh"
chmod +x /etc/set.sh
history -c
echo "1.2" > /home/ver
clear
