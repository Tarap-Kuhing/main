...
echo -e "${Info} Wireguard VPS AutoScript by Tarap-Kuhing"
...
# Tambahan
cd /usr/bin
wget -O add-wg "https://raw.githubusercontent.com/Tarap-Kuhing/main/main/wireguard/add-wg.sh"
wget -O del-wg "https://raw.githubusercontent.com/Tarap-Kuhing/main/main/wireguard/del-wg.sh"
wget -O cek-wg "https://raw.githubusercontent.com/Tarap-Kuhing/main/main/wireguard/cek-wg.sh"
wget -O renew-wg "https://raw.githubusercontent.com/Tarap-Kuhing/main/main/wireguard/renew-wg.sh"
chmod +x add-wg
chmod +x del-wg
chmod +x cek-wg
chmod +x renew-wg
