...
wget -O /usr/bin/add-l2tp https://raw.githubusercontent.com/Tarap-Kuhing/main/main/ipsec/add-l2tp.sh && chmod +x /usr/bin/add-l2tp
wget -O /usr/bin/del-l2tp https://raw.githubusercontent.com/Tarap-Kuhing/main/main/del-l2tp.sh && chmod +x /usr/bin/del-l2tp
wget -O /usr/bin/add-pptp https://raw.githubusercontent.com/Tarap-Kuhing/main/main/ipsec/add-pptp.sh && chmod +x /usr/bin/add-pptp
wget -O /usr/bin/del-pptp https://raw.githubusercontent.com/Tarap-Kuhing/main/main/ipsec/del-pptp.sh && chmod +x /usr/bin/del-pptp
wget -O /usr/bin/renew-pptp https://raw.githubusercontent.com/Tarap-Kuhing/main/main/ipsec/renew-pptp.sh && chmod +x /usr/bin/renew-pptp
wget -O /usr/bin/renew-l2tp https://raw.githubusercontent.com/Tarap-Kuhing/main/main/ipsec/renew-l2tp.sh && chmod +x /usr/bin/renew-l2tp
wget -O /usr/bin/cek-pptp https://raw.githubusercontent.com/Tarap-Kuhing/main/main/ipsec/cek-pptp.sh && chmod +x /usr/bin/cek-pptp
touch /var/lib/Tarap-Kuhing/data-user-l2tp
touch /var/lib/Tarap-Kuhing/data-user-pptp
rm -f /root/ipsec.sh
