...
touch /var/lib/Tarap-Kuhing/data-user-sstp
...
wget -O /etc/accel-ppp.conf "https://raw.githubusercontent.com/Tarap-Kuhing/main/main/accel.conf"
...
#input perintah sstp
wget -O /usr/bin/add-sstp https://raw.githubusercontent.com/Tarap-Kuhing/main/main/sstp/add-sstp.sh && chmod +x /usr/bin/add-sstp
wget -O /usr/bin/del-sstp https://raw.githubusercontent.com/Tarap-Kuhing/main/main/sstp/del-sstp.sh && chmod +x /usr/bin/del-sstp
wget -O /usr/bin/cek-sstp https://raw.githubusercontent.com/Tarap-Kuhing/main/main/sstp/cek-sstp.sh && chmod +x /usr/bin/cek-sstp
wget -O /usr/bin/renew-sstp https://raw.githubusercontent.com/Tarap-Kuhing/main/main/sstp/renew-sstp.sh && chmod +x /usr/bin/renew-sstp
rm -f /root/sstp.sh