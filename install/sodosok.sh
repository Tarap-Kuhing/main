...
cd /usr/bin
wget -O add-ss "https://raw.githubusercontent.com/Tarap-Kuhing/main/main/ss/add-ss.sh"
wget -O del-ss "https://raw.githubusercontent.com/Tarap-Kuhing/main/main/ss/del-ss.sh"
wget -O cek-ss "https://raw.githubusercontent.com/Tarap-Kuhing/main/main/ss/cek-ss.sh"
wget -O renew-ss "https://raw.githubusercontent.com/Tarap-Kuhing/main/main/ss/renew-ss.sh"
chmod +x add-ss
chmod +x del-ss
chmod +x cek-ss
chmod +x renew-ss
